...
# -*- coding: utf-8 -*-
"""
Created on Fri Sep 18 18:23:47 2020
...
end_train = '2018-04-16'
start_val = '2018-04-17'
end_val = '2020-08-28'
patience = 3
verbose = 1
Base_Dir = ''
...
#read csv file
DJIA = pd.read_csv("Combined_News_DJIA_plus1B_extended.csv", usecols=['Date', 'Label','Top1', 'Top2', 'Top3', 'Top4', 'Top5',
